    ...
    <div className={`wrapper w-screen flex justify-center h-full ${isDark ? 'bg-black text-white' : 'bg-[#F7F7F7] text-black'}`}>
      <div className="main flex flex-col items-center w-[80%] sm:w-[70%]">
        ...
        <div className="search w-full flex gap-4">
          ...
          <div className='dropdownBox flex justify-center gap-3.5'>
            <div className='drop dropdown relative' ref={dropdownRef}>
              <button ref={buttonRef} onClick={toggleDropdown} className={`selector ${isDark ? 'text-white' : 'text-black'}`}>
                ...
                {isOpen && (
                  <div className={`absolute top-full left-0 mt-1 w-full ${isDark ? 'bg-[#333] text-white' : 'bg-white text-black'} rounded-[15px] shadow-lg border border-[#6C63FF] z-10`}>
          ...
          <button onClick={handleShowModal} className={`cursor-pointer addTodo relative md:fixed md:bottom-[30px] md:right-[30px] bg-[#6C63FF] md:p-3 rounded-[50%] flex justify-center items-center hover:shadow-[0_0_10px_rgba(124,115,255,0.6)] hover:bg-[#7B73FF]`} style={{ minHeight: window.innerWidth < 768 ? `${buttonHeight}px` : 'auto' }}>
