    ...
    `}
            ...
            <div className='flex gap-3 items-center'>
                ...
                <div className='group hover:cursor-pointer' onClick={handleEditClick}>
                    {isEditing ? (
                        <svg xmlns="http://www.w3.org/2000/svg" className={`${props.isDark ? 'stroke-white fill-white' : 'stroke-black fill-black'} group-hover:stroke-green-400`} x="0px" y="0px" width="18" height="18" viewBox="0 0 50 50">
